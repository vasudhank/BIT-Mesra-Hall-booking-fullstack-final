   ...
   <Grid item xs={10} sm={8} md={8} lg={8} xl={8} style={{marginBottom:'0.5rem'}}>
        <div className='request-div-admin'>
         ...
         <Grid container spacing={3} justifyContent={'center'}>
             ...
             <Button size="small" type='submit' className='btn-admin-booking-request-accept'  onClick={acceptRequest} fullWidth sx={{ fontFamily: '"Times New Roman", Times, serif' }}>ACCEPT</Button>
             </Grid>


             <Grid item xs={10} sm={8} md={7} lg={5} xl={3}>
             <Button size="small" type='submit' className='btn-admin-booking-request-reject'  onClick={cancelRequest} fullWidth sx={{ fontFamily: '"Times New Roman", Times, serif' }}>REJECT</Button>
             </Grid>
